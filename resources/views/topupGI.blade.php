          ...
          <div class="row g-0 gx-5 align-items-end">
              <div class="col-lg-6">
                  <div class="section-header text-start mb-5 wow fadeInUp " data-wow-delay="0.1s" style="max-width: 400px;">
                      <h2 class="mb-3">Genshin Impact</h2>
                      <img class="img-fluid w-100" src="img/genshin.png">
                  </div>
              </div>
                  ...
                  <div class="row g-4">
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                          <div class="product-item">
                              <div class="position-relative bg-light overflow-hidden">
                                  <img class="img-fluid w-100" src="img/1gene.png" alt="">
                              </div>
                              <div class="text-center p-4">
                                  <p class="d-block h5 mb-2">60 Genesis</p>
                                  <span class="text-primary me-1">Rp.13.000</span>
                                  <span class="text-body text-decoration-line-through">Rp.17.000</span>
                              </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                          <div class="product-item">
                            <div class="product-item">
                              <div class="position-relative bg-light overflow-hidden">
                                  <img class="img-fluid w-100" src="img/2gene.png" alt="">
                              </div>
                              <div class="text-center p-4">
                                  <p class="d-block h5 mb-2">300+30 Genesis</p>
                                  <span class="text-primary me-1">Rp.65.000</span>
                                  <span class="text-body text-decoration-line-through">Rp.81.000</span>
                              </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="product-item">
                          <div class="product-item">
                            <div class="position-relative bg-light overflow-hidden">
                                <img class="img-fluid w-100" src="img/3gene.png" alt="">
                            </div>
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">980+110 Genesis</p>
                                <span class="text-primary me-1">Rp.205.000</span>
                                <span class="text-body text-decoration-line-through">Rp.255.000</span>
                            </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="product-item">
                          <div class="product-item">
                            <div class="position-relative bg-light overflow-hidden">
                                <img class="img-fluid w-100" src="img/4gene.png" alt="">
                            </div>
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">1980+260 Genesis</p>
                                <span class="text-primary me-1">Rp.410.000</span>
                                <span class="text-body text-decoration-line-through">Rp.490.000</span>
                            </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="product-item">
                          <div class="product-item">
                            <div class="position-relative bg-light overflow-hidden">
                                <img class="img-fluid w-100" src="img/5gene.png" alt="">
                            </div>
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">3280+600 Genesis</p>
                                <span class="text-primary me-1">Rp.640.000</span>
                                <span class="text-body text-decoration-line-through">Rp.815.000</span>
                            </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="product-item">
                          <div class="product-item">
                            <div class="position-relative bg-light overflow-hidden">
                                <img class="img-fluid w-100" src="img/6gene.png" alt="">
                            </div>
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">6480+1600 Genesis</p>
                                <span class="text-primary me-1">Rp.1.250.000</span>
                                <span class="text-body text-decoration-line-through">Rp.1.630.000</span>
                            </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="product-item">
                          <div class="product-item">
                            <div class="position-relative bg-light overflow-hidden">
                                <img class="img-fluid w-100" src="img/welkin.png" alt="">
                            </div>
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">Welkin Moon</p>
                                <span class="text-primary me-1">Rp.65.000</span>
                                <span class="text-body text-decoration-line-through">Rp.81.000</span>
                            </div>
                      ...
                      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="product-item">
                          <div class="product-item">
                            ...
                            <div class="text-center p-4">
                                <p class="d-block h5 mb-2">2x Welkin Moon</p>
                                <span class="text-primary me-1">Rp.130.000</span>
                                <span class="text-body text-decoration-line-through">Rp.162.000</span>
                            </div>
