  ...
  <body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
          ...
          <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg-transparent border-0">
                <a href="{{ url('datatablemember') }}" class="dropdown-item active">Member</a>
                <a href="{{ url('datatablepaymentall') }}" class="dropdown-item">All Payment</a>
                <a href="{{ url('datatablepaymentmobile') }}" class="dropdown-item">Mobile Game Payment</a>
                <a href="{{ url('datatablepaymentpc') }}" class="dropdown-item">PC Game Payment</a>
                <a href="{{ url('datatabletestimonial') }}" class="dropdown-item">Testimonial</a>
              </div>
            </div>
          </div>
        </nav>
      ...
      <div class="content">
        ...
        >
          <a href="{{ url('dashboardadmin') }}" class="navbar-brand d-flex d-lg-none me-4">
