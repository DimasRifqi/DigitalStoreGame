        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="{{ url('testimonialupdate')}}" class="dropdown-item active">Update Testimoni</a>
            ...
            <div class="col-sm-12 col-md-6 col-xl-12">
              <div class="bg-light rounded h-100 p-4">
                ...
                >
                  ...
                  <a href="widget.html">Back</a>
                </div>
                <form action="{{ route('testimonial_update', ['id' => $testimonial->id_testimoni]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nama_testimoni">Nama Testimonial:</label>
                        <input type="text" class="form-control" id="nama_testimoni" name="nama_testimoni" value="{{ $testimonial->nama_testimoni }}" required>
                    </div>
                    <div class="form-group">
                        <label for="pekerjaan_testimoni">Pekerjaan Testimonial:</label>
                        <input type="text" class="form-control" id="pekerjaan_testimoni" name="pekerjaan_testimoni" value="{{ $testimonial->pekerjaan_testimoni }}" required>
                    </div>
                    <div class="form-group">
                        <label for="komentar_testimoni">Komentar Testimonial:</label>
                        <textarea class="form-control" id="komentar_testimoni" name="komentar_testimoni" rows="4" required>{{ $testimonial->komentar_testimoni }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="foto_testimoni">Foto Testimonial:</label>
                        <input type="file" class="form-control-file" id="foto_testimoni" name="foto_testimoni">
                    </div>
